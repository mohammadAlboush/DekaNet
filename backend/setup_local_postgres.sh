#!/bin/bash
# ============================================================================
# Setup lokale PostgreSQL-Datenbank (Git Bash / Linux)
# ============================================================================
...
psql -U postgres -h localhost -c "DROP DATABASE IF EXISTS dekanat_migration;" 2>/dev/null
psql -U postgres -h localhost -c "CREATE DATABASE dekanat_migration;"
echo "   ✓ Datenbank erstellt"

echo ""
echo "[2/4] Erstelle Benutzer..."
psql -U postgres -h localhost -c "DROP USER IF EXISTS dekanat_user;" 2>/dev/null
